...
export function DataTableRowActions<TData>({
  ...
  const handleOpenConfig = async (app: 'application-config') => {
  ...
  return (
    <div className='-ml-1.5 flex items-center gap-1'>
      ...
      <Tooltip>
        <TooltipTrigger
          render={
            <Button
              variant='ghost'
              size='icon-sm'
              onClick={() => handleOpenConfig('application-config')}
              disabled={isRealKeyLoading}
              aria-label={t('Configure application')}
            />
          }
        >
          {isRealKeyLoading ? (
        ...
        <TooltipContent>{t('Configure application')}</TooltipContent>
      </Tooltip>
